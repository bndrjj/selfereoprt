...
const indicatorGuides = {
  "1-1-1-1": {
    procedures: [
      "وجود خطة تشغيلية مكتملة العناصر.",
      "أهداف الخطة محددة وقابلة للقياس.",
      "تحقيق البرامج والأنشطة للأهداف التطويرية للمدرسة.",
      "تضمنت الخطة التشغيلية مبادرات نوعية، مرتبطة بأهداف تطويرية طموحة.",
      "تضمنت الخطة التشغيلية خططًا للاستدامة والتحسين.",
      "توزيع الأدوار والمسؤوليات في تنفيذ الخطة على منسوبيها وفق خطتها الزمنية.",
      "إشراك 90% وأكثر من منسوبي المدرسة في إعداد الخطة التشغيلية.",
      "الاستناد على الأدلة الوزارية والمرجعيات عند بناء الخطة التشغيلية."
    ],
    assessmentTools: [
      "الاستبانات (المعلم).",
      "المقابلة (الإدارة المدرسية).",
      "تحليل الوثائق (خطة المدرسة التشغيلية)."
    ]
  },
  "1-1-1-2": {
    procedures: [
      "لديها إجراءات محددة لمتابعة تنفيذ البرامج في الخطة التشغيلية.",
      "تتابع تنفيذ البرامج والأنشطة وفق خطة زمنية واضحة.",
      "تُقوّم تنفيذ خطتها بأساليب متنوعة بما يضمن تحقيق أهدافها.",
  ...
  "1-2-1-1": {
    procedures: [
      ...
      "تنفيذ برامج الوعي الفكري وفق خططه وقواعده المعتمدة.",
      "تعمق الممارسات اليومية التي تعزز القيم الإسلامية والهوية الوطنية."
    ],
    assessmentTools: [
      "الاستبانات (المتعلم، المعلم، الأسرة).",
      "المقابلة (الموجه الطلابي).",
  ...
  "1-2-1-2": {
    procedures: [
      ...
      "يظهر منسوبي المدرسة التزامًا بقواعد السلوك الوظيفي وأخلاقيات المهنة.",
  ...
  "1-2-1-4": {
    procedures: [
      "توفر برامج وأنشطة وقائية وعلاجية للمشكلات السلوكية التي تواجه المتعلمين بما فيه ذوي الإعاقة، وتتابع تطبيقها.",
      "تطبق إجراءات لتشخيص المشكلات السلوكية.",
      "طبقت برامج وأنشطة تعزز السلوك الإيجابي لدى المتعلمين.",
      "طبقت برامج وأنشطة علاجية مرتبطة بنتائج تشخيص المشكلات السلوكية.",
      "تستثمر الشراكات المجتمعية لتعزيز السلوك الإيجابي.",
      "تحصر وتتابع المشكلات السلوكية والحالات الخاصة وتبني خطط للتدخلات المناسبة.",
      "تعمق الممارسات اليومية داعمة للسلوك الإيجابي لدى المتعلمين."
    ],
    assessmentTools: [
  ...
  "1-3-1-2": {
    procedures: [
      ...
      "توفر فرص للتواصل الفعال مع الأسرة بأساليب فاعلة ومتنوعة.",
  ...
  "1-5-1-1": {
    procedures: [
      ...
      "نشر الخطوط الساخنة: (خط مساندة الطفل 116111)، و(مركز بلاغات العنف الأسري 1919).",
      "توثيق الحقوق الشخصية والأسرية: الحق في الحضانة، والرعاية الأسرية.",
  ...
  "1-5-1-2": {
    procedures: [
      "طبقت برامج وأنشطة تضمن مناخًا آمنًا للتعلم وتحد من السلوك العدواني مثل حالات التنمر.",
      "طبقت برامج وأنشطة تعزز التعاون والعلاقات الإيجابية بين المتعلمين.",
      "تستخدم أساليب استباقية للكشف عن مؤشرات السلوك العدواني.",
