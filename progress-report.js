...
const indicatorTexts = {
  ...
  "1-2": [
    ...
    ["1-2-1-5", "نفذت المدرسة برامج وأنشطة إثرائية لتطوير مواهب المتعلمين، وتهيئتهم للمستقبل."],
  ],
  "1-3": [
    ["1-3-1-1", "تعزز المدرسة بناء العلاقات الإيجابية والتعاون في المجتمع المدرسي."],
    ["1-3-1-2", "تعزز المدرسة مشاركة الأسرة في تعلم أبنائها، والتحضير لمستقبلهم."],
    ["1-3-1-3", "تعزز المدرسة الشراكة المجتمعية؛ لدعم التعلم والتأثير الإيجابي في المجتمع."],
  ],
  "1-4": [
    ["1-4-1-1", "توفر المدرسة كادرًا تعليميًّا مكتملًا ومؤهلًا بما يتسق مع المهام الموكلة له (المدارس الأهلية والعالمية) ولا ينطبق على المدارس الحكومية."],
    ["1-4-1-2", "توفر المدرسة كادرًا إداريًّا مكتملًا ومؤهلاً بما يتسق مع المهام الموكلة له (المدارس الأهلية والعالمية) ولا ينطبق على المدارس الحكومية."],
    ["1-4-1-3", "تظهر المدرسة ثباتًا واستدامة مالية (المدارس الأهلية والعالمية) ولا ينطبق على المدارس الحكومية."],
    ["1-4-1-4", "تدعم المدرسة منسوبيها للحصول على الرخصة المهنية وتتابعها."],
    ["1-4-1-5", "تدعم المدرسة التطوير المهني لمنسوبيها وفقًا لنتائج تقويم الأداء الوظيفي وتحليل احتياجاتهم."],
  ...
  "1-5": [
    ["1-5-1-1", "تلتزم المدرسة بالمحافظة على حقوق المتعلمين وحمايته."],
    ["1-5-1-2", "توفر المدرسة مناخًا آمنًا للتعلم والنمو نفسيًا واجتماعيًا."],
  ],
  "2-1": [
